...
// It proxies the query to SearXNG and optionally scrapes each result.
...
func (h *V2SearchHandler) searchSearXNG(ctx context.Context, req models.V2SearchRequest) (*models.SearXNGResponse, error) {
...
func (h *V2SearchHandler) mapResults(searx []models.SearXNGResult, req models.V2SearchRequest) []models.V2SearchResult {
	limit := req.Limit
